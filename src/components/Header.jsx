...
export default function Header(props) {
  ...
  function submit(e) {
    e.preventDefault();
    if (input.match(/^[\d\w\s\-+*?#@$&()"']+$/))
      router.push("/search/[keyword]", `/search/${encodeURIComponent(input)}`);
    else return;
  }
  ...
  return (
    <React.Fragment>
      <AppBar
        color="transparent"
        className={`${trigger ? classes.opaque : classes.transparent} ${
          classes.appBar
        }`}
      >
          ...
          <div className={classes.IconList}>
            ...
            >
              <MenuItem className={classes.MenuItem}>
                <FormControlLabel
                  control={
                    <Switch checked={mode} name="DarkMode" color="primary" />
                  }
                  onChange={toggleMode}
                  label="Dark Mode"
                />
            ...
            {isLogIn && (
              <>
                <Link href="/watchlist" passHref scroll>
